          ...
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            >
              ...
              <p className="my-4 text-base font-medium md:text-sm sm:text-xs ">
                As a skilled full-stack Java developer, I am dedicated to
                turning ideas into innovative web and enterprise applications.
                Explore my latest projects and articles, showcasing my expertise
                in MERN, Java and Web development.
              </p>
              <div className="flex items-center self-start mt-2 lg:self-center">
                <Link
                  href="CV_Nitin_Akuch_2025.pdf"
                  target="_blank"
