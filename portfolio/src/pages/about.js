...
import profilePicPf from "../../public/images/profile/Profile1.jpg";
...
const about = () => {
  return (
    <>
      <Head>
        <title>Nitin Akuch | About Page</title>
      ...
      <main className="flex w-full flex-col items-center justify-center dark:text-light">
        <Layout className="pt-16">
          <AnimatedTexts
            ...
            className="mb-16 lg:!text-7xl sm:!text-6xl xs:!text-4xl sm:bm-8"
          />
